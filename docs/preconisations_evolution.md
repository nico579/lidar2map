...
|---|---|---|---|---|
| [R0](#r0-publier-la-version-et-la-valider-sur-de-vraies-machines) | Publier la PR #4 et la valider sur de vraies machines | P0 | S | reconstruction |
| [S1](#s1-requêtes-get-déclenchées-par-dautres-sites) | Requêtes GET déclenchées par d'autres sites | P1 | S | reconstruction |
| [S2](#s2-open_folder-ouvre-nimporte-quel-chemin) | `open_folder` ouvre n'importe quel chemin | P1 | XS | patch |
| [D1](#d1-tester-lexécutable-construit-dans-releaseyml) | Tester l'exécutable construit dans `release.yml` | P1 | M | CI |
| [S4](#s4-json-avec-bom-lu-comme-corrompu) | JSON avec BOM lu comme corrompu | P2 | XS | reconstruction |
| [S5](#s5-contexte-tls-sans-vérification-dans-le-provider-finlandais) | Contexte TLS sans vérification (Finlande) | P2 | XS | reconstruction |
| [Doc1](#doc1-test-de-cohérence-entre-options-cli-et-documentation) | Test de cohérence options CLI ↔ doc | P2 | S | tests |
| [Doc2](#doc2-dérives-documentaires-connues) | Dérives documentaires connues | P2 | XS | doc et CI |
| [C1](#c1-reliquats-pywebview-dans-le-gui-web) | Reliquats pywebview dans le GUI web | P3 | M | patch et reconstruction |
| [C2](#c2-entrées-mortes-du-bootstrap) | Entrées mortes du bootstrap | P3 | XS | reconstruction |
