...
echo ""
ok "Setup terminé. Aucun script de build Linux dédié n'existe encore :"
echo "    Construire manuellement via :"
echo "      \"\$VENV/bin/pyinstaller\" lidar2map_win.spec --clean --noconfirm"
echo "    puis zipper dist_onedir/lidar2map → lidar2map_bundle.zip"
echo "    et builder le launcher avec lidar2map_win_launcher.spec."
