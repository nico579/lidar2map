...
TEST_POINTS = {
    ...
    "fr-ign-laz": (5.86628, 43.37579),       # Ruine1 Var (COPC 205 Mo ! --skip en CI)
    "ch-swisstopo-laz": (7.442, 46.949),     # Berne (swissSURFACE3D .las.zip 125 Mo ! --skip en CI)
    "fr-craig": (3.22472, 45.65783),         # Enval (CRAIG MNT .asc 0,5 m, léger)
    "fr-craig-laz": (3.22472, 45.65783),     # Enval (nuage classé CRAIG ~10 Mo ! --skip en CI)
...
APIKEY_ENV = {"us-3dep": "OPENTOPOGRAPHY_API_KEY",
              "dk-datafordeler": "DATAFORDELER_API_KEY",
              "dk-datafordeler-laz": "DATAFORDELER_API_KEY",
