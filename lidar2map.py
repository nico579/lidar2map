...
from _terrain_cli import (
    DependancesParserLidar as _DependancesParserLidar,
...
def _appliquer_defauts_cli_lidar(args):
    """Façade historique vers les défauts de la CLI terrain extraite."""
    return _appliquer_defauts_cli_lidar_impl(args)
...
def _construire_parser_lidar():
    """Façade historique vers le parser de la CLI terrain extraite."""
    return _construire_parser_lidar_impl(
        dependances=_DependancesParserLidar(
            argparse=argparse,
            ...
            shading_types_ordre=SHADING_TYPES_ORDRE,
            version=VERSION,
